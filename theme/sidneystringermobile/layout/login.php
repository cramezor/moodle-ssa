...
<head>
    <title>Sidney Stringer Academy VLE | ssa-vle.org.uk</title>
    ...
    <link rel=stylesheet type=text/css href="http://ssa-vle.org.uk/theme/sidneystringermobile/style/login.css">
    <?php echo $OUTPUT->standard_head_html() ?>
    <meta name="description" content="A VLE for students and staff at Sidney Stringer Academy.">
...
<div id="login-page" class="container-fluid">
    ...
    <div id="login-page-content" class="row-fluid">
